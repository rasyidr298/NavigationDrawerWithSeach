...
public class FragmentAll extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Grid Layout
        recyclerView.setLayoutManager(new GridLayoutManager(FragmentAll.this.getActivity(),2));
        addData();

        //set adapter
        adapter = new RecyclerViewAdapter(FragmentAll.this.getActivity(), mItems,null);
